...
open_button_ = Button(tab2, text="Click Me!", command=new_win, padx=5, pady=5, bg='black', fg=orig_color)
...
def light_mode():
    ...
    open_button_.configure(bg=orig_color, fg="black")  
    ...
    Button_0_.configure(bg=orig_color, fg="black")  
    Button_1_.configure(bg=orig_color, fg="black")
    Button_2_.configure(bg=orig_color, fg="black")
    Button_3_.configure(bg=orig_color, fg="black")
    Button_4_.configure(bg=orig_color, fg="black")
    Button_5_.configure(bg=orig_color, fg="black")
    Button_6_.configure(bg=orig_color, fg="black")
    Button_7_.configure(bg=orig_color, fg="black")
    Button_8_.configure(bg=orig_color, fg="black")
    Button_9_.configure(bg=orig_color, fg="black")
    Button_add_.configure(bg=orig_color, fg="black")
    Button_subtract_.configure(bg=orig_color, fg="black")
    Button_divide_.configure(bg=orig_color, fg="black")
    Button_multiply_.configure(bg=orig_color, fg="black")
    Button_open_paranthesis_.configure(bg=orig_color, fg="black")
    Button_close_paranthesis_.configure(bg=orig_color, fg="black")
    Button_equal_.configure(bg=orig_color, fg="black")
    Button_point_.configure(bg=orig_color, fg="black")
    Button_exit_.configure(bg=orig_color, fg="black")
    Button_clear_.configure(bg=orig_color, fg="black")
...
menubar.configure(bg="black", fg=orig_color)
aboutmenu.configure(bg="black", fg=orig_color)
# filemenu.configure(bg="black", fg=orig_color)
settingsmenu.configure(bg="black", fg=orig_color)
editmenu.configure(bg="black", fg=orig_color)
open_button.configure(bg="black", fg=orig_color)
